...
switch ($_POST['conversao']) {
    ...
    case 'km-metro':
        ...
        break;
    case 'cel-fah':
        $convercao = $param * FATOR_CEL_FAH + 32;
        $mensagem = "{$param}° Celsius = {$convercao}° Fahrenheit";
        break;
    case 'fah-cel':
        $convercao = ($param - 32) / FATOR_CEL_FAH;
        $mensagem = "{$param}° Fahrenheit = {$convercao}° Celsius";
        break;
    default:
